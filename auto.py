...
try:
    ...
    print("Brain successfully loaded! Type a partial sentence and let the AI finish it.")
except FileNotFoundError:
    print("ERROR: Could not find checkpoint. Check the filename.")
    sys.exit()
...
#The chat loop
print("\n" + "="*40)
print(" MicroGPT Autocomplete Engine")
print("="*40 + "\n")

temperature = 0.6 # Kept slightly low to prevent it from going completely crazy
max_new_tokens = 40 # How many words it generates
...
while True:
    ...
    # Print the user's text first, so it looks seamless
    print(f"\nCompletion: {user_prompt}", end="", flush=True)
